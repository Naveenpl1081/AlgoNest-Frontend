...
const AiTutorPage = () => {
  ...
  const handleTryAiTutor = async () => {
    const response = await aiAuthService.checkPremium();
  ...
  const features = [
    {
      ...
      description:
        "Get help understanding complex algorithms and data structures with step-by-step explanations",
    },
    {
      icon: <Lightbulb className="w-6 h-6" />,
      title: "Logic Building",
      description:
        "Learn problem-solving approaches and develop strong logical thinking for coding challenges",
    },
    {
      icon: <MessageSquare className="w-6 h-6" />,
      title: "24/7 Available",
      description:
        "Ask questions anytime and get instant, personalized responses tailored to your learning pace",
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: "Concept Clarity",
      description:
        "Deep dive into programming concepts with examples, analogies, and practical applications",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">
            Struggling with how to approach a problem? Confused about logic
            building or coding concepts? Our advanced AI tutor is here to guide
            you through every challenge, providing personalized explanations and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">
                Type any coding doubt, problem approach, or concept you need
                help with
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">
                Receive detailed explanations, hints, and step-by-step solutions
                instantly
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">
                Learn at your own pace and build strong problem-solving skills
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600/20 via-purple-600/20 to-blue-600/20 border border-blue-500/30 rounded-2xl p-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Join thousands of students who are improving their coding skills
              with personalized AI assistance. No question is too small, no
              concept too complex.
            </p>
            <button
              onClick={handleTryAiTutor}
