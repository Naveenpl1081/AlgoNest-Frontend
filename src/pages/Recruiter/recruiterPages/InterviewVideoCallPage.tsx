...
const RecruiterVideoCallPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initCall = async () => {
      try {
        console.log("Initializing recruiter call...");
      ...
      <div className="flex-1 flex flex-col">
          ...
          <div>
            ...
            <div className="mt-0.5">
              {isConnected ? (
                ...
                <span className="text-yellow-400 text-xs">● Waiting for candidate...</span>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 relative bg-black">
          ...
          <div className="absolute top-4 left-4 bg-black/70 px-3 py-1.5 rounded text-sm">
            {remoteScreenStream ? "Candidate's Screen" : "Candidate"}
          </div>
        ...
        <div className="w-80 bg-gray-800 border-l border-gray-700 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {messages.map((msg, idx) => (
              <div key={idx} className={`${msg.sender === 'Recruiter' ? 'text-right' : 'text-left'}`}>
                <div className={`inline-block max-w-[80%] rounded-lg p-2 ${
                  msg.sender === 'Recruiter' ? 'bg-blue-600' : 'bg-gray-700'
                }`}>
...
export default RecruiterVideoCallPage;