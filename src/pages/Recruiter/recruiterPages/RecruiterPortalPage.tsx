          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-12 leading-relaxed max-w-lg">
                Find the perfect candidate for your tech roles faster and
                smarter with our intuitive recruitment platform.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-slate-700/30 to-slate-600/20 backdrop-blur-md rounded-3xl p-8 border border-slate-600/50 group hover:scale-105 transition-all duration-300">
              <div className="relative h-48 mb-6 flex items-center justify-center">
                <div className="relative">
                  ...
                  <div
                    className="absolute -bottom-4 -left-8 w-6 h-6 bg-blue-500/20 rounded-full animate-bounce"
                    style={{ animationDelay: "0.5s" }}
                  ></div>
                  <div
                    className="absolute -bottom-4 -right-8 w-4 h-4 bg-purple-500/20 rounded-lg animate-bounce"
                    style={{ animationDelay: "1s" }}
                  ></div>
                </div>
              </div>
              ...
              <h3 className="text-2xl font-bold mb-4 text-white">
                Hire the Best Tech Talent with Our Comprehensive Recruitment
                Platform
              </h3>
            ...
            <div className="bg-gradient-to-br from-slate-700/30 to-slate-600/20 backdrop-blur-md rounded-3xl p-8 border border-slate-600/50 group hover:scale-105 transition-all duration-300">
              <div className="relative h-48 mb-6 flex items-center justify-center">
                <div className="relative">
                  ...
                  <div
                    className="absolute bottom-4 left-8 w-2 h-2 bg-pink-500/30 rounded-full animate-pulse"
                    style={{ animationDelay: "0.5s" }}
                  ></div>
                </div>
              </div>
              ...
              <h3 className="text-2xl font-bold mb-4 text-white">
                Streamline Your Technical Interviews and Select the Top Talent
                with Ease
              </h3>
