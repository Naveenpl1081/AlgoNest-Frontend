        ...
        <div className="p-6 space-y-6">
          {isProcessing ? (
            <div className="flex flex-col items-center justify-center py-14 space-y-8">
              ...
              {/* Text Content */}
              <div className="text-center space-y-4 fade-in-scale" style={{ animationDelay: '0.2s' }}>
                <div className="space-y-2">
                  ...
                  <p className="text-purple-200 text-sm max-w-sm mx-auto">
                    Analyzing resumes and matching candidates with job requirements
                  </p>
                </div>
              ...
              {/* Progress Bar */}
              <div className="w-full max-w-sm space-y-2 fade-in-scale" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="relative w-full h-2 bg-slate-800/50 rounded-full overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-600 rounded-full" style={{ width: '65%' }}></div>
                </div>
              </div>
            </div>
          ) : (
            <>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-400">
                  Candidates matching above this percentage will be
                  shortlisted
                </p>
              </div>
